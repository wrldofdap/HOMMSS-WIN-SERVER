...
let UomoHelpers = {
    ...
    hideHoverComponents: () => {
        document
            .querySelectorAll(UomoSelectors.jsContentVisible)
            .forEach((el) => {
                el.classList.remove(
                    UomoSelectors.jsContentVisible.substring(1)
                );
            });
    },
...
(function () {
        ...
        function JsHoverContent() {
            ...
            document.querySelectorAll(".js-hover__open").forEach((el) => {
                el.addEventListener("click", (e) => {
                    ...
                    const $container =
                        e.currentTarget.closest(".hover-container");
        ...
        function QtyControl() {
            document
                ...
                .forEach(function ($qty) {
                    ...
                    const $increase = $qty.querySelector(
        ...
        Search.prototype = Object.assign({}, Search.prototype, {
            _initSearchSelect: function () {
                ...
                this.$containers.forEach((el) => {
                    ...
                    const $inputBox = el.querySelector(
                    ...
                    $inputBox &&
                        $inputBox.addEventListener("keyup", (e) => {
                            ...
                            el.querySelectorAll(
                                _this.selectors.searchSuggestItem
                            ).forEach((el) => {
                     ...
                     */
                    el.querySelectorAll(
                        _this.selectors.searchCategorySelector
                    ).forEach((scs) => {
            ...
            _initSearchReset: function () {
                const _this = this;
                document
                    .querySelectorAll(this.selectors.resetButton)
                    .forEach((el) => {
                        el.addEventListener("click", function (e) {
                            const $parentDiv = e.target.closest(
                                _this.selectors.container
                            );
            ...
            _initSearchInputFocus: function () {
                ...
                document
                    .querySelectorAll(this.selectors.inputBox)
                    .forEach((el) => {
            ...
            _updateSearchResult: function (data, $form) {
                const $ajaxDom = new DOMParser().parseFromString(
                    data,
                    "text/html"
                );
        ...
        Aside.prototype = Object.assign({}, Aside.prototype, {
            _init: function () {
                ...
                this.$asideActivators.forEach(function ($activator) {
                    $activator.addEventListener("click", (event) => {
                        ...
                        $targetAside &&
                            $targetAside.classList.add(
                                _this.selectors.activeClass
                            );
                    });
                });
            },
            ...
            _initBackDropClick() {
                if (UomoSelectors.$pageBackDrop) {
                    UomoSelectors.$pageBackDrop.addEventListener(
                        "click",
                        () => {
                            this._closeAside();
                        }
        ...
        StickyElement.prototype = Object.assign({}, StickyElement.prototype, {
            _init: function () {
                ...
                this.$stickies.forEach(function ($sticky) {
                    const $grid =
                        $sticky.previousElementSibling ||
                        $sticky.nextElementSibling;
                    const $target =
                        $grid.offsetHeight > $sticky.offsetHeight
                            ? $sticky
                            : $grid;
    ...
    UomoSections.Header = (function () {
        ...
        Header.prototype = Object.assign({}, Header.prototype, {
            ...
            _initMobileMenu: function () {
                ...
                if ($mobileDropdown) {
                    $mobileMenuActivator &&
                        $mobileMenuActivator.addEventListener(
                            "click",
                            function (event) {
                                event.preventDefault();
                                if (
            ...
            _initStickyHeader: function () {
                if (
                    this.$header.classList.contains(this.selectors.stickyHeader)
                ) {
                    return;
                }
            ...
            _setBoxMenuPosition(menu) {
                const limitR =
                    window.innerWidth - menu.offsetWidth - scrollBarWidth;
                const limitL = 0;
            ...
            _stickyScrollHander() {
                ...
                if (
                    ...
                    this.$header.classList.remove(
                        this.selectors.stickyActiveClass
                    );
    ...
    UomoSections.CustomerSideForm = (function () {
        ...
        CustomerSideForm.prototype = Object.assign(
            {},
            CustomerSideForm.prototype,
            {
    ...
    UomoSections.CartDrawer = (function () {
        function CartDrawer() {
            ...
            this.$header = this.$aside.querySelector(
                this.selectors.asideHeader
            );
            this.$actions = this.$aside.querySelector(
                this.selectors.cartActions
            );
            this.$list = this.$aside.querySelector(
                this.selectors.cartItemsList
            );
    ...
    UomoSections.SwiperSlideshow = (function () {
        ...
        SwiperSlideshow.prototype = Object.assign(
            {},
            SwiperSlideshow.prototype,
            {
                _initSliders() {
                    this.$containers.forEach(function ($sliderContainer) {
                        if (
                            $sliderContainer.classList.contains(
    ...
    UomoElements.StarRating = (function () {
        function StarRating() {
            ...
            let user_selected_star =
                document.querySelector("#form-input-rating");
    ...
    class Uomo {
        ...
        _initMultiSelect($containers) {
            $containers.forEach((el) => {
                 ...
                 */
                const $selectArray =
                    $component.querySelectorAll(".js-multi-select");
                $selectArray.forEach((el) => {
                    el.addEventListener("click", function (e) {
                        ...
                        if (
                            $actor &&
                            !$actor.classList.contains("js-no-update")
                        ) {
    ...
    $('a[data-bs-toggle="tab"]').on("shown.bs.tab", function (e) {
        ...
        if (
            ...
            document
                .querySelectorAll(
                    ".tab-pane" + paneTarget + " .swiper-container"
                )
    ...
    var registerButton = document.querySelector(".js-show-register");
    if (registerButton) {
            ...
            if ($(".mobile_fixed-btn_wrapper").length > 0) {
                if ($(this).width() < 992 && $(this).width() >= 768) {
                    if (
                        ...
                        $(
                            ".mobile_fixed-btn_wrapper > .button-wrapper"
                        ).addClass("fixed-btn");
                    } else {
                        $(
                            ".mobile_fixed-btn_wrapper > .button-wrapper"
    ...
    Array.prototype.slice.call(forms).forEach(function (form) {
        form.addEventListener(
            ...
            function (event) {
                ...
                form.querySelectorAll("input[data-cf-pwd]").forEach(function (
                    el
                ) {
                    if (
                        form.querySelector(el.getAttribute("data-cf-pwd"))
                            .value != el.value
                    ) {
                        event.preventDefault();
                        event.stopPropagation();
        ...
        form.querySelectorAll("input[data-cf-pwd]").forEach(function (el) {
            el.addEventListener("keyup", function (event) {
                if (
                    !el.value ||
                    form.querySelector(el.getAttribute("data-cf-pwd")).value !=
                        el.value
                ) {
            ...
            form.querySelector(el.getAttribute("data-cf-pwd")).addEventListener(
                "keyup",
                function (event) {
                    if (
                        !el.value ||
