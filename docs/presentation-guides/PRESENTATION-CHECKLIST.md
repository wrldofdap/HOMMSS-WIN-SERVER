# PBL Presentation Checklist - HOMMSS E-Commerce Platform ##**Pre-Presentation Setup (30 minutes before)**###**Technical Preparation**- [ ]**Clean the project:**`php cleanup-project.php`
